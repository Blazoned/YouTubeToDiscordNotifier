...
namespace DiscordYouTubeNotifier.Services.DataStoreService
{
    public interface ISubscriberDataStore
    {
        ...
        SubscriberScheme GetWebhook(Guid session);
        // Update
        /// <summary>
        ...
        /// <param name="session">The session token.</param>
        void LockWebhook(string secret, Guid session);
        /// <summary>
        /// Add a human readable name to the webhook.
        /// </summary>
        /// <param name="name">The webhook to update.</param>
        /// <param name="session">The session token.</param>
        void AddPseudonym(SubscriberScheme subscriber, Guid session);
        // Delete
        /// <summary>
        ...
        /// <param name="session">The session token.</param>
        void DeleteWebhook(SubscriberScheme subscriber, Guid session);
        #endregion
        ...
        SubscriptionScheme<SubscriberScheme, ChannelScheme> Subscribe(string topic, Guid session);
        // Read
        /// <summary>
        ...
        List<SubscriptionScheme<SubscriberScheme,ChannelScheme>> GetSubscriptions(Guid session);
        // Update
        /// <summary>
        ...
        /// <param name="session">The session token.</param>
        void SetSubscriptionPseudonym(SubscriptionScheme<SubscriberScheme, ChannelScheme> subscription, Guid session);
        /// <summary>
        /// Set or update the message for a subscription.
        /// </summary>
        /// <param name="subscription">The subscription to update.</param>
        /// <param name="session">The session token.</param>
        void SetSubscriptionMessage(SubscriptionScheme<SubscriberScheme,ChannelScheme> subscription, Guid session);
        // Delete
        /// <summary>
        ...
        /// <param name="session">The session token.</param>
        void RemoveSubscription(SubscriptionScheme<SubscriberScheme, ChannelScheme> subscription, Guid session);
        #endregion
    }
}
